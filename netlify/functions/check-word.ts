...
- Interaction logique :
  Le nouveau mot doit avoir une capacité démontrable à détruire, casser, neutraliser, supplanter, ou corrompre l'ancien mot, dans un contexte physique, conceptuel, émotionnel, social, relationnel, ou naturel. La relation entre les mots doit être cohérente et directement applicable.
...
- Absence d'interaction pertinente :
  Le nouveau mot ne peut pas logiquement interagir avec l'ancien dans aucun des contextes définis.
...
- Non-adaptabilité au contexte :
  Le mot soumis n'est pas adapté pour guérir, détruire, manipulé, surpassé etc...
